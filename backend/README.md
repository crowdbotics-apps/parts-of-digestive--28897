...
## Project Structure
    ...
    ├── parts_of_digestive__28897  # Django project configurations
...
1. Clone this repo and `cd parts_of_digestive__28897`
...
2. Clone this repo and `cd parts_of_digestive__28897`
